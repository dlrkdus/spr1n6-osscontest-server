...
올린 문서를 문단 단위로 나눠 1536차원 벡터로 색인하고, 하이브리드 검색(RRF)으로 가장 가까운 대목을 찾습니다. 검색어와 글자가 겹치지 않아도 의미가 유사하면 조회됩니다. 여기에 형태소 분석과 BM25, Reranking을 결합해, **합성 QA 평가 풀 기준 Recall@10 을 0.31 에서 0.79 까지** 끌어올렸습니다.
